...
function contact() {
  ...
  const { mode } = context
  return (
    <div className='  md:py-6 mb-7 '>
      <div>
        <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-10 xl:px-10 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg"
          style={{
          ...
          <div className>
            <div>
              ...
              <input className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="text" style={{
                backgroundColor: mode === 'dark' ? 'rgb(32, 35, 42)' : '',
                color: mode === 'dark' ? 'white' : 'black',
              }}
              />
            </div>
            ...
            <div className="mt-8">
              ...
              <textarea className="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"  style={{
                backgroundColor: mode === 'dark' ? 'rgb(32, 35, 42)' : '',
                color: mode === 'dark' ? 'white' : 'black',
              }} />
            </div>
